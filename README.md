...
* Go to **OAuth & Permissions**. Add following scopes in **Scopes** section: `channels:read`, `chat:write`, `chat:write.customize`, `chat:write.public`, `im:write`, `users:read`, `users:read.email`. 
