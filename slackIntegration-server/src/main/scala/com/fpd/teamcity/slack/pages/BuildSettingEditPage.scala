...
class BuildSettingEditPage(
  ...
  controllerManager.registerController(
    Resources.buildSettingEdit.controllerUrl,
    this
  )
  ...
  override def handle(
    ...
    val view =
      descriptor.getPluginResourcesPath(Resources.buildSettingEdit.view)
    ...
    result getOrElse new ModelAndView(
      view,
      Map("defaultMessage" -> SBuildMessageBuilder.defaultMessage).asJava
    )
  }
